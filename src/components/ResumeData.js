...
CSS, JavaScript, and Bootstrap. Built dynamic and interactive UI components using jQuery, improving 
user engagement and site usability. Collaborated closely with UI/UX designers to convert design mockups into functional web pages. Ensured cross-browser compatibility and responsive behavior across different devices and screen sizes. Participated in debugging, testing, and performance optimization of frontend features. `
    },
    {
